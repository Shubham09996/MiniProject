    ...
    try {
      if (isLogin) {
        ...
        const { error } = await supabase.auth.signUp({
          ...
          options: {
            data: {
              ...
              first_name: firstName, // Restored firstName to signup data
              last_name: lastName, // Restored lastName to signup data
            },
        ...
        toast({
          ...
          description: "Welcome to Phantom Finance. Please check your email.",
        });
        navigate("/");
      }
    } catch (error: any) {
